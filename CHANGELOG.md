...
- **Features**
  ...
  - Add merge request approval tools
    ...
    - `get_merge_request_approval_state` - Get the approval state including rules and who has approved
...
- **Dependencies**
  - Bump qs from 6.14.0 to 6.14.1 ([#300](https://github.com/zereight/gitlab-mcp/pull/300))
    - Security/maintenance update for query string parsing
