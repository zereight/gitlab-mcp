...
> **Note**: This project is forked from [zereight/gitlab-mcp](https://github.com/zereight/gitlab-mcp). The changelog below reflects the history from the original project. New changes specific to this fork will be added above this note.
