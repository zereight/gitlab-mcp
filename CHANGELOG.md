...
- fix: strip null optional tool arguments before Zod validation ([#281](https://github.com/zereight/gitlab-mcp/issues/281))
- fix: validate incomplete merge request position via schema preprocess, not generic tool-arg stripping
