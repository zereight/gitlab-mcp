import { SchemaIntrospector, FieldInfo, TypeInfo, SchemaInfo } from '../../../src/services/SchemaIntrospector';
...
describe('SchemaIntrospector', () => {
  ...
  describe('introspectSchema', () => {
    it('should successfully introspect schema and cache results', async () => {
      ...
      expect(schema.workItemWidgetTypes).toEqual(['ASSIGNEES', 'LABELS', 'MILESTONE', 'DESCRIPTION']);
    ...
    it('should handle introspection errors gracefully', async () => {
      ...
      expect(schema.workItemWidgetTypes).toEqual([
        'ASSIGNEES', 'LABELS', 'MILESTONE', 'DESCRIPTION',
        'START_AND_DUE_DATE', 'WEIGHT', 'TIME_TRACKING',
        'HEALTH_STATUS', 'COLOR', 'NOTIFICATIONS', 'NOTES'
      ]);
      expect(schema.typeDefinitions).toBeInstanceOf(Map);
  ...
  describe('Edge Cases and Error Handling', () => {
    ...
    it('should cache schema results for sequential calls', async () => {
      ...
      expect(result1.workItemWidgetTypes).toEqual(['ASSIGNEES', 'LABELS', 'MILESTONE', 'DESCRIPTION']);
