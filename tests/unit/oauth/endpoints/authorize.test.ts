...
import { initiateDeviceFlow, pollDeviceFlowOnce, getGitLabUser } from '../../../../src/oauth/gitlab-device-flow';
...
describe('OAuth Authorization Endpoint', () => {
  ...
  describe('authorizeHandler', () => {
    ...
    it('should initiate device flow and return HTML', async () => {
    ...
    it('should store device flow state correctly', async () => {
      mockInitiateDeviceFlow.mockResolvedValue({
