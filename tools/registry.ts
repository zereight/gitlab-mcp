...
export const allTools = [
  ...
  { name: "stop_stale_environments", description: "Stop stale environments", inputSchema: toJSONSchema(StopStaleEnvironmentsSchema) },
  { name: "delete_review_app_environments", description: "Delete stopped review-app environments", inputSchema: toJSONSchema(DeleteReviewAppEnvironmentsSchema) },
