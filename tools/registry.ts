...
export const TOOLSET_DEFINITIONS: readonly ToolsetDefinition[] = [
  ...
  },
  {
    ...
    tools: new Set([
      ...
      "list_pipeline_schedules", "get_pipeline_schedule", "create_pipeline_schedule", "update_pipeline_schedule", "delete_pipeline_schedule", "play_pipeline_schedule", "take_pipeline_schedule_ownership",
      "list_deployments",
      "get_deployment",
      "list_environments",
      "get_environment",
