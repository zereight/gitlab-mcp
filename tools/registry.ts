...
export const allTools = [
  ...
  { name: "list_pipeline_schedules", description: "List pipeline schedules", inputSchema: toJSONSchema(ListPipelineSchedulesSchema) },
  { name: "get_pipeline_schedule", description: "Get a pipeline schedule", inputSchema: toJSONSchema(PipelineScheduleIdSchema) },
  { name: "create_pipeline_schedule", description: "Create a pipeline schedule", inputSchema: toJSONSchema(CreatePipelineScheduleSchema) },
  { name: "update_pipeline_schedule", description: "Update a pipeline schedule", inputSchema: toJSONSchema(UpdatePipelineScheduleSchema) },
  { name: "delete_pipeline_schedule", description: "Delete a pipeline schedule", inputSchema: toJSONSchema(PipelineScheduleIdSchema) },
  { name: "play_pipeline_schedule", description: "Run a pipeline schedule immediately", inputSchema: toJSONSchema(PipelineScheduleIdSchema) },
  { name: "take_pipeline_schedule_ownership", description: "Take ownership of a pipeline schedule", inputSchema: toJSONSchema(PipelineScheduleIdSchema) },
  { name: "list_pipeline_schedule_pipelines", description: "List pipelines run by a pipeline schedule", inputSchema: toJSONSchema(ListPipelineSchedulePipelinesSchema) },
  { name: "get_pipeline_schedule_variable", description: "Get a pipeline schedule variable", inputSchema: toJSONSchema(PipelineScheduleVariableSchema) },
  { name: "create_pipeline_schedule_variable", description: "Create a pipeline schedule variable", inputSchema: toJSONSchema(CreatePipelineScheduleVariableSchema) },
  { name: "update_pipeline_schedule_variable", description: "Update a pipeline schedule variable", inputSchema: toJSONSchema(UpdatePipelineScheduleVariableSchema) },
  { name: "delete_pipeline_schedule_variable", description: "Delete a pipeline schedule variable", inputSchema: toJSONSchema(PipelineScheduleVariableSchema) },
  {
...
export const TOOLSET_DEFINITIONS: readonly ToolsetDefinition[] = [
  ...
  },
  {
    ...
    tools: new Set([
      ...
      "take_pipeline_schedule_ownership",
      "list_pipeline_schedule_pipelines",
      "get_pipeline_schedule_variable",
