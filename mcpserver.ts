...
import {DEFAULT_HEADERS, ensureSessionForRequest, fetch} from "./agent.js"
...
import { DEFAULT_FETCH_CONFIG } from "./agent.js";
...
async function listMergeRequests(
  ...
  projectId = decodeURIComponent(projectId); // Decode project ID
  const url = new URL(`${config.GITLAB_API_URL}/projects/${encodeURIComponent(getEffectiveProjectId(projectId))}/merge_requests`);
...
async function getIssue(projectId: string, issueIid: number): Promise<GitLabIssue> {
  projectId = decodeURIComponent(projectId); // Decode project ID
  const url = new URL(
    `${config.GITLAB_API_URL}/projects/${encodeURIComponent(getEffectiveProjectId(projectId))}/issues/${issueIid}`
  );
...
async function listIssueLinks(
  ...
  projectId = decodeURIComponent(projectId); // Decode project ID
  const url = new URL(
    `${config.GITLAB_API_URL}/projects/${encodeURIComponent(getEffectiveProjectId(projectId))}/issues/${issueIid}/links`
  );
...
async function createOrUpdateFile(
  ...
  const encodedPath = encodeURIComponent(filePath);
  const url = new URL(
    `${config.GITLAB_API_URL}/projects/${encodeURIComponent(getEffectiveProjectId(projectId))}/repository/files/${encodedPath}`
  );
...
async function createTree(
  ...
  projectId = decodeURIComponent(projectId); // Decode project ID
  const url = new URL(
    `${config.GITLAB_API_URL}/projects/${encodeURIComponent(getEffectiveProjectId(projectId))}/repository/tree`
  );
...
async function createCommit(
  ...
  projectId = decodeURIComponent(projectId); // Decode project ID
  const url = new URL(
    `${config.GITLAB_API_URL}/projects/${encodeURIComponent(getEffectiveProjectId(projectId))}/repository/commits`
  );
...
async function createRepository(
  ...
  const response = await fetch(`${config.GITLAB_API_URL}/projects`, {
    ...DEFAULT_FETCH_CONFIG,
    method: "POST",
    body: JSON.stringify({
      name: options.name,
...
async function getBranchDiffs(
  ...
  const url = new URL(
    `${config.GITLAB_API_URL}/projects/${encodeURIComponent(getEffectiveProjectId(projectId))}/repository/compare`
  );
...
async function updateMergeRequest(
  ...
  const url = new URL(
    `${config.GITLAB_API_URL}/projects/${encodeURIComponent(getEffectiveProjectId(projectId))}/merge_requests/${mergeRequestIid}`
  );
...
async function getProject(
  ...
  projectId = decodeURIComponent(projectId); // Decode project ID
  const url = new URL(`${config.GITLAB_API_URL}/projects/${encodeURIComponent(getEffectiveProjectId(projectId))}`);
...
async function listProjects(
  ...
  const response = await fetch(`${config.GITLAB_API_URL}/projects?${params.toString()}`, {
    ...DEFAULT_FETCH_CONFIG,
  });
...
async function listLabels(
  ...
  const url = new URL(`${config.GITLAB_API_URL}/projects/${encodeURIComponent(getEffectiveProjectId(projectId))}/labels`);
...
async function createLabel(
  ...
  const response = await fetch(
    `${config.GITLAB_API_URL}/projects/${encodeURIComponent(getEffectiveProjectId(projectId))}/labels`,
    {
      ...DEFAULT_FETCH_CONFIG,
      method: "POST",
      body: JSON.stringify(options),
...
async function listWikiPages(
  ...
  projectId = decodeURIComponent(projectId); // Decode project ID
  const url = new URL(`${config.GITLAB_API_URL}/projects/${encodeURIComponent(getEffectiveProjectId(projectId))}/wikis`);
  if (options.page) url.searchParams.append("page", options.page.toString());
  if (options.per_page) url.searchParams.append("per_page", options.per_page.toString());
...
async function getWikiPage(projectId: string, slug: string): Promise<GitLabWikiPage> {
  projectId = decodeURIComponent(projectId); // Decode project ID
  const response = await fetch(
    `${config.GITLAB_API_URL}/projects/${encodeURIComponent(getEffectiveProjectId(projectId))}/wikis/${encodeURIComponent(slug)}`,
    { ...DEFAULT_FETCH_CONFIG }
  );
  await handleGitLabError(response);
  const data = await response.json();
...
async function createWikiPage(
  ...
  const response = await fetch(
    `${config.GITLAB_API_URL}/projects/${encodeURIComponent(getEffectiveProjectId(projectId))}/wikis`,
    {
      ...DEFAULT_FETCH_CONFIG,
      method: "POST",
      body: JSON.stringify(body),
...
async function listPipelines(
  ...
  projectId = decodeURIComponent(projectId); // Decode project ID
  const url = new URL(`${config.GITLAB_API_URL}/projects/${encodeURIComponent(getEffectiveProjectId(projectId))}/pipelines`);
...
async function getPipeline(projectId: string, pipelineId: number): Promise<GitLabPipeline> {
  projectId = decodeURIComponent(projectId); // Decode project ID
  const url = new URL(
    `${config.GITLAB_API_URL}/projects/${encodeURIComponent(getEffectiveProjectId(projectId))}/pipelines/${pipelineId}`
  );
...
async function listPipelineJobs(
  ...
  projectId = decodeURIComponent(projectId); // Decode project ID
  const url = new URL(
    `${config.GITLAB_API_URL}/projects/${encodeURIComponent(getEffectiveProjectId(projectId))}/pipelines/${pipelineId}/jobs`
  );
...
async function getPipelineJob(projectId: string, jobId: number): Promise<GitLabPipelineJob> {
  projectId = decodeURIComponent(projectId); // Decode project ID
  const url = new URL(`${config.GITLAB_API_URL}/projects/${encodeURIComponent(getEffectiveProjectId(projectId))}/jobs/${jobId}`);
...
async function getPipelineJobOutput(projectId: string, jobId: number, limit?: number, offset?: number): Promise<string> {
  projectId = decodeURIComponent(projectId); // Decode project ID
  const url = new URL(
    `${config.GITLAB_API_URL}/projects/${encodeURIComponent(getEffectiveProjectId(projectId))}/jobs/${jobId}/trace`
  );
...
async function createPipeline(
  ...
  projectId = decodeURIComponent(projectId); // Decode project ID
  const url = new URL(`${config.GITLAB_API_URL}/projects/${encodeURIComponent(getEffectiveProjectId(projectId))}/pipeline`);
...
async function retryPipeline(projectId: string, pipelineId: number): Promise<GitLabPipeline> {
  projectId = decodeURIComponent(projectId); // Decode project ID
  const url = new URL(
    `${config.GITLAB_API_URL}/projects/${encodeURIComponent(getEffectiveProjectId(projectId))}/pipelines/${pipelineId}/retry`
  );
...
async function cancelPipeline(projectId: string, pipelineId: number): Promise<GitLabPipeline> {
  projectId = decodeURIComponent(projectId); // Decode project ID
  const url = new URL(
    `${config.GITLAB_API_URL}/projects/${encodeURIComponent(getEffectiveProjectId(projectId))}/pipelines/${pipelineId}/cancel`
  );
...
async function listProjectMilestones(
  ...
  const url = new URL(`${config.GITLAB_API_URL}/projects/${encodeURIComponent(getEffectiveProjectId(projectId))}/milestones`);
...
async function getProjectMilestone(
  ...
  projectId = decodeURIComponent(projectId);
  const url = new URL(
    `${config.GITLAB_API_URL}/projects/${encodeURIComponent(getEffectiveProjectId(projectId))}/milestones/${milestoneId}`
  );
...
async function getMilestoneIssues(projectId: string, milestoneId: number): Promise<GitLabIssue[]> {
  projectId = decodeURIComponent(projectId);
  const url = new URL(
    `${config.GITLAB_API_URL}/projects/${encodeURIComponent(getEffectiveProjectId(projectId))}/milestones/${milestoneId}/issues`
  );
...
async function promoteProjectMilestone(
  ...
  projectId = decodeURIComponent(projectId);
  const url = new URL(
    `${config.GITLAB_API_URL}/projects/${encodeURIComponent(getEffectiveProjectId(projectId))}/milestones/${milestoneId}/promote`
  );
...
async function getCommit(
  ...
  projectId = decodeURIComponent(projectId);
  const url = new URL(
    `${config.GITLAB_API_URL}/projects/${encodeURIComponent(getEffectiveProjectId(projectId))}/repository/commits/${encodeURIComponent(sha)}`
  );
...
async function getCommitDiff(
  ...
  projectId = decodeURIComponent(projectId);
  const url = new URL(
    `${config.GITLAB_API_URL}/projects/${encodeURIComponent(getEffectiveProjectId(projectId))}/repository/commits/${encodeURIComponent(sha)}/diff`
  );
  ...
  try {
    ...
    switch (request.params.name) {
      ...
      case "get_namespace": {
        ...
        const url = new URL(
          `${config.GITLAB_API_URL}/namespaces/${encodeURIComponent(args.namespace_id)}`
        );
      ...
      case "verify_namespace": {
        ...
        const url = new URL(`${config.GITLAB_API_URL}/namespaces/${encodeURIComponent(args.path)}/exists`);
      ...
      case "get_project": {
        ...
        const url = new URL(`${config.GITLAB_API_URL}/projects/${encodeURIComponent(args.project_id)}`);
