      ...
      handler: async (args: unknown) => {
        ...
        switch (input.action) {
          ...
          case "update": {
            ...
            return gitlab.put(
              `projects/${normalizeProjectId(project_id)}/merge_requests/${mrIid}`,
          ...
          case "merge": {
            ...
            return gitlab.put(
              `projects/${normalizeProjectId(project_id)}/merge_requests/${mrIid}/merge`,
