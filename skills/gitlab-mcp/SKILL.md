...
GitLab MCP server providing 238 tools: 236 tools across 20 toolsets, plus `execute_graphql` and the always-available `discover_tools` meta-tool.
...
| groups (1 tool) | yes | - |
| users (7 tools) | yes | - |
| pipelines (36 tools) | no | `USE_PIPELINE=true` or `GITLAB_TOOLSETS=pipelines` |
